...
本文主要讲解JDK内部集合类、Apache Commons Collection中的**集合类**、Guava中的**集合类**、并发**集合类**、Redission分**布式集合类**。

## [#](https://www.xuanyuanli.cn/pages/d2e513/#一、jdk内部集合)一、JDK内部集合

### [#](https://www.xuanyuanli.cn/pages/d2e513/#_1、数组)1、数组
...
- `spliterator`：拆分器。大多数情况下，你都不需要使用到这个方法，他主要是跟StreamSupport配合使用。参考[java8 Stream之Spliterator(opens new window)](https://blog.csdn.net/weixin_38308374/article/details/112972462)
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2、list)2、List

`List`是有序的集合，允许重复元素，可以通过索引访问元素。为了解决数组长度固定不能动态扩容的问题，Java提供了`List`接口及其实现类。

#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2-1、主要实现类对比)2.1、主要实现类对比
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2-2、arraylist详解)2.2、ArrayList详解
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2-3、linkedlist详解)2.3、LinkedList详解
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2-4、vs-linkedlist选择指南)2.4、vs LinkedList选择指南
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3、set)3、Set

`Set`是不包含重复元素的集合，主要用于去重和判断元素是否存在。继承自`Collection`接口。

#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3-1、set实现类对比)3.1、Set实现类对比
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3-2、hashset实现原理)3.2、HashSet实现原理
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3-3、linkedhashset特点)3.3、LinkedHashSet特点
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3-4、treeset特点)3.4、TreeSet特点
...
NavigableSet是对SortedSet的导航扩展，报告给定搜索目标的最接近匹配。参考[NavigableSet Api(opens new window)](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/NavigableSet.html)
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_4、map)4、Map

`Map`是键值对集合，每个键最多映射到一个值。它不是`Collection`接口的子接口，是一个独立的接口体系。

#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_4-1、map实现类对比)4.1、Map实现类对比
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_4-2、hashmap深度解析)4.2、HashMap深度解析
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_4-3、linkedhashmap特性)4.3、LinkedHashMap特性
...
#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_4-4、treemap特性)4.4、TreeMap特性
...
TreeMap还实现了NavigableMap->SortedMap，参考[NavigableMap Api(opens new window)](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/NavigableMap.html)

### [#](https://www.xuanyuanli.cn/pages/d2e513/#_5、其他)5、其他
...
## [#](https://www.xuanyuanli.cn/pages/d2e513/#二、commons-collection集合)二、Commons Collection集合
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_1、工具类)1、工具类
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2、容器类)2、容器类
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3、辅助类)3、辅助类

主要是Comparator、Predicate、Transformer等辅助类，这些辅助类在Java8 Stream面前都显得有些过时了，不赘言

## [#](https://www.xuanyuanli.cn/pages/d2e513/#三、guava集合)三、Guava集合

如果说commons-collections4是质朴村花的话，那么Guava就是靓丽女神了。
Guava中最受欢迎的就是他的集合类。

### [#](https://www.xuanyuanli.cn/pages/d2e513/#_1、不可变系列对象)1、不可变系列对象
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2、新的集合类型)2、新的集合类型
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3、实用工具类)3、实用工具类
...
这些工具类中方法众多，具体参考：[Guava 集合工具扩展(opens new window)](https://github.com/google/guava/wiki/CollectionUtilitiesExplained)
...
## [#](https://www.xuanyuanli.cn/pages/d2e513/#四、并发集合)四、并发集合
...
## [#](https://www.xuanyuanli.cn/pages/d2e513/#五、redission分布式集合)五、Redission分布式集合
...
Redission还对分布式环境下常用操作做了一些封装，这已经超出了本章要讨论的内容，参考：[Redisson项目介绍(opens new window)](https://github.com/redisson/redisson/wiki/Redisson项目介绍)

## [#](https://www.xuanyuanli.cn/pages/d2e513/#六、集合选择指南)六、集合选择指南

### [#](https://www.xuanyuanli.cn/pages/d2e513/#_1、如何选择合适的集合)1、如何选择合适的集合
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2、性能对比总结)2、性能对比总结

#### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2-1、时间复杂度对比)2.1、时间复杂度对比
...
## [#](https://www.xuanyuanli.cn/pages/d2e513/#七、最佳实践)七、最佳实践

### [#](https://www.xuanyuanli.cn/pages/d2e513/#_1、初始化容量)1、初始化容量
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2、使用合适的遍历方式)2、使用合适的遍历方式
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3、正确实现equals和hashcode)3、正确实现equals和hashCode
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_4、避免在循环中修改集合)4、避免在循环中修改集合
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_5、选择合适的并发集合)5、选择合适的并发集合
...
## [#](https://www.xuanyuanli.cn/pages/d2e513/#八、常见面试题)八、常见面试题

### [#](https://www.xuanyuanli.cn/pages/d2e513/#_1、arraylist和linkedlist的区别)1、ArrayList和LinkedList的区别？
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_2、hashmap的工作原理)2、HashMap的工作原理？
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_3、如何保证集合线程安全)3、如何保证集合线程安全？
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_4、fail-fast和fail-safe的区别)4、fail-fast和fail-safe的区别？
...
### [#](https://www.xuanyuanli.cn/pages/d2e513/#_5、为什么hashmap的容量是2的幂次方)5、为什么HashMap的容量是2的幂次方？

- 位运算效率高：`(n-1) & hash`比取模运算快
- 均匀分布：2的幂次方-1的二进制全是1，与运算后分布更均匀
- 扩容优化：扩容时元素要么在原位置，要么在原位置+旧容量位置

## [#](https://www.xuanyuanli.cn/pages/d2e513/#九、总结)九、总结
