...
## [#](https://www.xuanyuanli.cn/pages/302748/#一、何为线程池)一、何为线程池
...
## [#](https://www.xuanyuanli.cn/pages/302748/#二、先来讲讲executors与executorservice)二、先来讲讲`Executors`与`ExecutorService`

JDK中自然提供了一套线程池的实现，核心实现类是`ThreadPoolExecutor`。

### [#](https://www.xuanyuanli.cn/pages/302748/#_1、线程池体系结构)1、线程池体系结构
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_2、scheduledexecutorservice)2、ScheduledExecutorService
...
## [#](https://www.xuanyuanli.cn/pages/302748/#三、重头戏之threadpoolexecutor)三、重头戏之ThreadPoolExecutor

`Executors`的工厂方法比较合适初学者使用，简单直接。但在生产环境中，我们通常需要更精细的控制，这就需要深入了解`ThreadPoolExecutor`的内部实现。

### [#](https://www.xuanyuanli.cn/pages/302748/#_1、线程池的工作原理)1、线程池的工作原理
...
会发现他其实是返回了一个`ThreadPoolExecutor`对象，可以确定`ThreadPoolExecutor`就是线程池的实现类了，那`ThreadPoolExecutor`构造函数的这几个参数都是什么意思呢？ 看一下`ThreadPoolExecutor`最丰富的构造，其他构造都是调用这个的：
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_1-1、核心参数说明)1.1、核心参数说明
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_2、workqueue-工作队列详解)2、workQueue - 工作队列详解

工作队列是线程池的核心组件之一，不同的队列类型会导致不同的线程池行为。如果对`BlockingQueue`不熟悉，请参考[Java并发-阻塞队列BlockingQueue](https://www.xuanyuanli.cn/pages/f344d1/)。

常用的工作队列有以下几种：

#### [#](https://www.xuanyuanli.cn/pages/302748/#_2-1、synchronousqueue-直接提交队列)2.1、`SynchronousQueue` - 直接提交队列
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_2-2、arrayblockingqueue-有界队列)2.2、`ArrayBlockingQueue` - 有界队列
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_2-3、linkedblockingqueue-无界队列)2.3、`LinkedBlockingQueue` - 无界队列
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_2-4、priorityblockingqueue-优先级队列)2.4、`PriorityBlockingQueue` - 优先级队列
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_2-5、delayqueue-延迟队列)2.5、`DelayQueue` - 延迟队列

- **特点**：队列中的元素只有到达指定延迟时间后才能被获取
- **使用场景**：定时任务、延迟任务

### [#](https://www.xuanyuanli.cn/pages/302748/#_3、threadfactory-线程工厂)3、threadFactory - 线程工厂
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_3-1、基本使用示例)3.1、基本使用示例
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_3-2、使用guava的threadfactorybuilder)3.2、使用Guava的ThreadFactoryBuilder
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_4、rejectedexecutionhandler-拒绝策略)4、rejectedExecutionHandler - 拒绝策略

当线程池和任务队列都满了，新任务将被拒绝。选择合适的拒绝策略对系统稳定性至关重要。

#### [#](https://www.xuanyuanli.cn/pages/302748/#_4-1、jdk内置拒绝策略)4.1、JDK内置拒绝策略

##### [#](https://www.xuanyuanli.cn/pages/302748/#a、abortpolicy-中止策略-默认)a、`AbortPolicy` - 中止策略（默认）
...
##### [#](https://www.xuanyuanli.cn/pages/302748/#b、callerrunspolicy-调用者运行策略)b、`CallerRunsPolicy` - 调用者运行策略
...
##### [#](https://www.xuanyuanli.cn/pages/302748/#c、discardoldestpolicy-丢弃最老任务策略)c、`DiscardOldestPolicy` - 丢弃最老任务策略
...
##### [#](https://www.xuanyuanli.cn/pages/302748/#d、discardpolicy-丢弃策略)d、`DiscardPolicy` - 丢弃策略
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_4-2、自定义拒绝策略)4.2、自定义拒绝策略
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_5、扩展线程池)5、扩展线程池
...
## [#](https://www.xuanyuanli.cn/pages/302748/#四、生产环境最佳实践)四、生产环境最佳实践

### [#](https://www.xuanyuanli.cn/pages/302748/#_1、为什么不推荐使用executors)1、为什么不推荐使用Executors？

阿里巴巴Java开发手册明确指出：**线程池不允许使用Executors去创建，而是通过ThreadPoolExecutor的方式**。

让我们分析一下`Executors`工厂方法的问题：

#### [#](https://www.xuanyuanli.cn/pages/302748/#_1-1、newfixedthreadpool和newsinglethreadexecutor的问题)1.1、`newFixedThreadPool`和`newSingleThreadExecutor`的问题
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_1-2、newcachedthreadpool和newscheduledthreadpool的问题)1.2、`newCachedThreadPool`和`newScheduledThreadPool`的问题
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_2、推荐的线程池配置方式)2、推荐的线程池配置方式
...
## [#](https://www.xuanyuanli.cn/pages/302748/#五、异常处理的注意事项)五、异常处理的注意事项

### [#](https://www.xuanyuanli.cn/pages/302748/#_1、对比execute的异常处理差异)1、对比execute的异常处理差异

线程池提供了两种提交任务的方式，它们在异常处理上有重要区别：

#### [#](https://www.xuanyuanli.cn/pages/302748/#_1-1、execute-方法)1.1、execute()方法
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_1-2、submit-方法)1.2、submit()方法
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_2、最佳实践-统一的异常处理)2、最佳实践：统一的异常处理
...
## [#](https://www.xuanyuanli.cn/pages/302748/#六、线程池的关闭策略)六、线程池的关闭策略

### [#](https://www.xuanyuanli.cn/pages/302748/#_1、为什么需要关闭线程池)1、为什么需要关闭线程池？

线程池中的核心线程默认会一直存活，即使没有任务执行。如果不手动关闭线程池，JVM将无法正常退出。

### [#](https://www.xuanyuanli.cn/pages/302748/#_2、两种关闭方法的区别)2、两种关闭方法的区别

#### [#](https://www.xuanyuanli.cn/pages/302748/#_2-1、shutdown-优雅关闭)2.1、`shutdown()` - 优雅关闭
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_2-2、shutdownnow-立即关闭)2.2、`shutdownNow()` - 立即关闭
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_3、优雅关闭的最佳实践)3、优雅关闭的最佳实践
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_4、使用countdownlatch确保所有任务完成)4、使用CountDownLatch确保所有任务完成
...
## [#](https://www.xuanyuanli.cn/pages/302748/#七、线程池参数调优)七、线程池参数调优

### [#](https://www.xuanyuanli.cn/pages/302748/#_1、如何合理配置线程池参数)1、如何合理配置线程池参数？

#### [#](https://www.xuanyuanli.cn/pages/302748/#_1-1、核心线程数和最大线程数的设置)1.1、核心线程数和最大线程数的设置
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_1-2、队列容量的设置)1.2、队列容量的设置
...
#### [#](https://www.xuanyuanli.cn/pages/302748/#_1-3、动态调整线程池参数)1.3、动态调整线程池参数
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_2、线程池监控)2、线程池监控
...
## [#](https://www.xuanyuanli.cn/pages/302748/#八、常见问题和解决方案)八、常见问题和解决方案

### [#](https://www.xuanyuanli.cn/pages/302748/#_1、线程池死锁)1、线程池死锁
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_2、任务执行时间过长)2、任务执行时间过长
...
### [#](https://www.xuanyuanli.cn/pages/302748/#_3、内存泄漏)3、内存泄漏
...
## [#](https://www.xuanyuanli.cn/pages/302748/#九、总结)九、总结
